...
export const Footer = () => {
  return (
    ...
    <div className="w-12 border-t-2 border-customBlue mb-4 sm:mx-auto md:mx-0"></div>
    <p className="opacity-80 mb-2 sm:text-center md:text-left">+1 891 989-11-91</p>
    <p className="opacity-80 sm:text-center md:text-left">info@logoipsum.com</p>
  </div>

        {/* Second Column */}
        <div className="flex flex-col items-center sm:items-start border-b-2 md:border-b-0 border-white pb-8 md:pb-0 lg:mx-16">
        ...
        {/* Third Column */}
        <div className="flex flex-col items-center sm:items-start pb-2 md:border-b-0">
